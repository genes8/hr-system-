      ...
      <div className="flex-grow p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="question-bank">
            <Card>
              <CardHeader>
                <CardTitle>Banka pitanja</CardTitle>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        <Badge variant="secondary">Srednje</Badge>
                      </TableCell>
                      <TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Badge variant="secondary">Lako</Badge>
                      </TableCell>
                      <TableCell>
                        <div className="flex space-x-2">
                          <Button variant="ghost" size="icon">
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <Badge variant="secondary">Teško</Badge>
                      </TableCell>
                      <TableCell>
                        <div className="flex space-x-2">
                          <Button variant="ghost" size="icon">
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          <Badge variant="success">Položio</Badge>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-medium">
                        ...
                        <TableCell>
                          <Badge variant="success">Položila</Badge>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-medium">
