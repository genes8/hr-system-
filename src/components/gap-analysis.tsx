...
import { Search, ChevronDown, ChevronUp, ArrowRight, AlertTriangle, CheckCircle, TrendingUp, TrendingDown, Zap, Book, Award } from 'lucide-react'
...
export function GapAnalysis() {
  ...
  const getCompetencyGap = (competencyId) => {
