...
import { AlertCircle, Award, BarChart, BookOpen, Clock, DollarSign, FileText, PlusCircle, RefreshCw, Search, TrendingUp, Users } from 'lucide-react'

export function PracenjeSertifikata() {
                ...
                <TableBody>
                  {certificates.map((cert) => (
                    <TableRow key={cert.id}>
                      ...
                      <TableCell>
                        <Badge variant={cert.status === "Aktivan" ? "success" : cert.status === "Ističe uskoro" ? "warning" : "destructive"}>
                          {cert.status}
                        </Badge>
                      </TableCell>
                      <TableCell>
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      <li className="flex justify-between items-center">
                        ...
                        <Badge variant="warning">Ističe za 30 dana</Badge>
                      </li>
                      <li className="flex justify-between items-center">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="h-[200px] w-full bg-slate-100 rounded flex items-center justify-center">
                      [Pie chart troškova po tipu sertifikata]
                    </div>
                  </CardContent>
                </Card>
              </div>
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Zaštita na r</TableCell>
