...
export default function BazaZnanja() {
  console.log('BazaZnanja komponenta se učitava');
          ...
          <TabsContent value="dashboard">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Uvid u statistiku i popularnost sadržaja</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          <div className="flex items-center">
                            <Tag className="mr-2 h-4 w-4" />
                            <Badge variant="outline" className="mr-1">Transformatori</Badge>
                            <Badge variant="outline">Održavanje</Badge>
                          </div>
                        </TableCell>
                      </TableRow>
                      <TableRow>
